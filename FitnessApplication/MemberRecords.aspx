<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberRecords.aspx.cs" Inherits="FitnessApplication.MemberRecords" %>
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0f0f0f; color: ghostwhite; margin: 0;">
    ...
    Style="position:absolute; top:1.5rem; right:2rem;
           background:transparent; border:1px solid ghostwhite;
           padding:0.4rem 1rem; border-radius:8px;
           color:ghostwhite; font-weight:500;
           transition:all .2s ease; cursor:pointer;"
    OnMouseOver="this.style.background='ghostwhite';this.style.color='#0f0f0f';"
    OnMouseOut="this.style.background='transparent';this.style.color='ghostwhite';">
    Home
</asp:LinkButton>
